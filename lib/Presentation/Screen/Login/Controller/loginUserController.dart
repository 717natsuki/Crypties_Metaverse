...
import 'package:crypties_app/Model/User/loginUser.dart';
import 'package:crypties_app/exports.dart';

void loginUserController(email, password, context,)async{
  ...
  if (result == true){
    ...
    Navigator.pushNamedAndRemoveUntil(
        context, kNavigatorString.loading, ModalRoute.withName(''));
    // create first post
    try{
