...
class ConnectMetamask extends StatefulWidget {
  @override
  _ConnectMetamaskState createState() => _ConnectMetamaskState();
}

class _ConnectMetamaskState extends State<ConnectMetamask> {
  @override
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                          onTap: ()async  {
                            ...
                            String urlLaunch = 'https://metamask.io/download'.toString();
                            if (await canLaunch(urlLaunch)) {
                              await launch(urlLaunch);
                            } else {
                              errorPopup('Error','URL is invalid',context);
