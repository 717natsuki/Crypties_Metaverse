...
import 'package:crypties_app/Presentation/Screen/Search/Controller/getAllRecentNFTs.dart';
import 'package:crypties_app/exports.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';


class PopularNFTs extends StatefulWidget {
  @override
  _PopularNFTsState createState() => _PopularNFTsState();
}

class _PopularNFTsState extends State<PopularNFTs> with AutomaticKeepAliveClientMixin {
  ...
  void initFunc()async{
    nfts = await getAllPopularNFTs(0);
    setState(() {
      loaded = true;
      nfts = nfts;
    });
  ...
  void _onLoading() async {
    List<OpenseaNFT> afterPost = await getAllPopularNFTs(offset+1);
